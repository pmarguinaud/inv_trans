...
INTEGER :: ISIZE, JFLD, IOFF (SIZE (YLFL)), ILEN (SIZE (YLFL))
...
DO JFLD = 1, SIZE (YLFL)
  ...
  SELECT TYPE (YLF => YLFB)
    ...
    CLASS IS (FIELD_2RB)
      ...
      ISIZE = ISIZE + (IUBOUNDS (2) - ILBOUNDS (2) + 1)
    CLASS DEFAULT
      STOP 1
  END SELECT

  ILEN (JFLD) = ISIZE - IOFF (JFLD) 
...
DO JFLD = 1, SIZE (YLFL)
  ...
  print *, IOFF (JFLD)+1, "..", IOFF (JFLD)+ILEN (JFLD)
  SELECT TYPE (YLF => YLFL (JFLD)%PTR)
    CLASS IS (FIELD_1RB)
      LS (IOFF (JFLD)+1:IOFF (JFLD)+ILEN (JFLD)) = LS1RB (YLF)
    CLASS IS (FIELD_2RB)
      LS (IOFF (JFLD)+1:IOFF (JFLD)+ILEN (JFLD)) = LS2RB (YLF)
    CLASS DEFAULT
      STOP 1
  END SELECT
